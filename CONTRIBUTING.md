...
Report bugs at https://github.com/SophieAbsf/frost_day/issues.
...
FROST-DAY could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/SophieAbsf/frost_day/issues.
...
Ready to contribute? Here's how to set up frost_day for local development.

1. Fork the frost_day repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/frost_day.git
   ```
