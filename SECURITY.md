...
If you find a security vulnerability in FROST-DAY, please report it through [GitHub's private vulnerability reporting](https://github.com/SophieAbsf/frost_day/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact femiaholou@gmail.com for details.
